 ...
 */
final class Version20220204133351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, decription VARCHAR(255) NOT NULL, brand VARCHAR(255) DEFAULT NULL, serial_number VARCHAR(255) NOT NULL, date_added DATETIME NOT NULL, date_buy DATE DEFAULT NULL, problem LONGTEXT DEFAULT NULL, diagnosis LONGTEXT DEFAULT NULL, solution LONGTEXT DEFAULT NULL, quote_number INT DEFAULT NULL, quote_date DATE DEFAULT NULL, quote_amount INT DEFAULT NULL, repair_delay INT DEFAULT NULL, repair_date DATE DEFAULT NULL, return_date DATE DEFAULT NULL, client_feedback VARCHAR(255) DEFAULT NULL, client_feedback_date DATE DEFAULT NULL, INDEX IDX_92FB68E19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
